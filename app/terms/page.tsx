...
export default function Terms() {
  return (
    <article className="legal">
      ...
      <h2>Who we are</h2>
      <p>{site.name} provides motorcycle transport and logistics services in the United Kingdom, and breakdown pickups where availability allows. We do not carry out repairs or diagnose faults. These terms apply to every booking made through this website, by phone or by message.</p>
      ...
      <p>We take reasonable care of your bike while it is in our van. It travels in a fully enclosed van and is covered by our goods in transit insurance from loading to delivery. The van has interior and exterior cameras for security. Please remove valuables and tell us about any existing damage before collection; we photograph every bike when it is loaded. We are not responsible for pre-existing faults, or for loose items left on the bike.</p>
