...
export default function Terms() {
  return (
    <article className="legal">
      ...
      <h2>Who we are</h2>
      <p>{site.name} provides motorcycle recovery, transport and repair services in the United Kingdom. These terms apply to every booking made through this website, by phone or by message.</p>
      ...
      <h2>Repairs</h2>
      <p>If your bike comes to our workshop we will give you a written quote for any repair before starting work. We will not carry out work you have not agreed to. Where we find further faults during a repair we will stop and ask you before going on. Replaced parts are kept for you to inspect on request.</p>

      <h2>Payment</h2>
      <p>Transport is payable on delivery. Repairs are payable when the bike is collected or returned. We accept bank transfer and card. We may hold a bike until the agreed balance is paid.</p>
      ...
      <p>We take reasonable care of your bike while it is in our van or workshop and it is covered by our goods-in-transit and workshop insurance. Please remove valuables and tell us about any existing damage before collection; we photograph every bike when it is loaded. We are not responsible for pre-existing faults, or for loose items left on the bike.</p>

      <h2>Storage</h2>
      <p>Bikes left at our workshop more than fourteen days after we have asked you to collect them may incur a daily storage charge, which we will tell you about in writing first.</p>
