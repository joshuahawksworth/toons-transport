 ...
 *   NEXT_PUBLIC_BASE_AREA  e.g. "West Yorkshire" (where the workshop is)
 */
export const site = {
  name: "Toon Transport",
  slogan: "Broken down? We'll pick you up.",
  description:
    "Toon Transport collects broken-down motorbikes anywhere in the UK, fixes them in our workshop and brings them back. Book a pickup online in two minutes.",
